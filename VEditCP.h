...
template <class T>
class CProxy_IVEditObj3Events : public IConnectionPointImpl<T, &DIID__IVEditObj3Events, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_Complete()
	{
	...
	HRESULT Fire_PosChange(DOUBLE NewPos)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_EffectListed(BSTR strName, BSTR strGuid)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_AviCodecListed(BSTR CodecName, BSTR CodecGuid, EnumMediaType CodecType)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_WMVProfileListed(INT Index, BSTR ProfileName, BSTR ProfileDescription)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_SaveProgress(DOUBLE dCurrent, DOUBLE dMax)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
